...
class ArchiveDiffActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        infoCard.addView(row("", "仅存档有", formatNum(j.optLong("onlyInArchive", 0)), M3.colorTertiary(this)))
        infoCard.addView(row("", "仅手机有", formatNum(j.optLong("onlyInPhone", 0)), M3.colorTertiary(this)))
